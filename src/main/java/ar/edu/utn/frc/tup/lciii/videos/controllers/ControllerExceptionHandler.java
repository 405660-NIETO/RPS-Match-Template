...
import ar.edu.utn.frc.tup.lciii.videos.dtos.common.ErrorApi;
...
public class ControllerExceptionHandler {
    ...
    /*
    Con este metodo podemos devolver un mensaje especifico mediante Reason y interceptar este manejo
    de excepciones especificas de esta manera
     */
    ...
    public ErrorApi buildError(String message, HttpStatus status) {
